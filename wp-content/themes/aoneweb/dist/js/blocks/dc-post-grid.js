...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    usesPagination: function usesPagination() {
      if (typeof this.initial_model !== 'undefined' && this.initial_model.post_navigation_type === 'pagination') {
        return true;
      }
    ...
    showLoadMore: function showLoadMore() {
      // If pagination is set rather than load more, show the page navigation/loadmore anyway
      // Ignore the fact that this function is called showLoadMore, it doesn't make any sense.
  ...
  methods: {
    ...
    updateTotalPosts: function updateTotalPosts(newTotalPostNumber) {
      this.totalPosts = newTotalPostNumber;
    },
  ...
  mounted: function mounted() {
    ...
    if (typeof this.initial_model.total_posts !== 'undefined') {
      this.totalPosts = this.initial_model.total_posts;
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    reset: function reset() {
      this.$emit('update-filter', this.name, null, this.usesMultiselect);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadMore: function loadMore(currentPaged) {
      this.currentPaged = currentPaged + 1;
      this.$emit('update-current-paged', this.currentPaged);
    },
    countVisiblePosts: function countVisiblePosts() {
      return this.$parent.$refs['resultsWrapperInnerAlt'].length;
    }
  },
  watch: {
    loading: function loading() {
      this.totalVisiblePosts = this.countVisiblePosts();
    }
  },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGrid.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGrid.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _DcPostGridResults__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DcPostGridResults */ "./src/blocks/dc-post-grid/layout/DcPostGridResults.vue");
/* harmony import */ var _Filters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Filters */ "./src/blocks/dc-post-grid/layout/Filters.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  "extends": _dc_post_grid_layout_DcPostGrid__WEBPACK_IMPORTED_MODULE_0__.default,
  components: {
    DcPostGridResults: _DcPostGridResults__WEBPACK_IMPORTED_MODULE_1__.default,
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGridResults.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGridResults.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _dc_post_grid_mixins_Translatable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dc-post-grid/mixins/Translatable */ "../../plugins/dc-post-grid/src/mixins/Translatable.js");
/* harmony import */ var _cards_Default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cards/Default */ "./src/blocks/dc-post-grid/layout/cards/Default.vue");
/* harmony import */ var _ui_LoadMore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ui/LoadMore */ "./src/blocks/dc-post-grid/layout/ui/LoadMore.vue");
/* harmony import */ var _dc_post_grid_layout_ui_Pagination__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @dc-post-grid/layout/ui/Pagination */ "../../plugins/dc-post-grid/src/layout/ui/Pagination.vue");
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    Default: _cards_Default__WEBPACK_IMPORTED_MODULE_1__.default,
    LoadMore: _ui_LoadMore__WEBPACK_IMPORTED_MODULE_2__.default,
    Pagination: _dc_post_grid_layout_ui_Pagination__WEBPACK_IMPORTED_MODULE_3__.default
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/Filters.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/Filters.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _dc_post_grid_layout_Filters_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dc-post-grid/layout/Filters.vue */ "../../plugins/dc-post-grid/src/layout/Filters.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  "extends": _dc_post_grid_layout_Filters_vue__WEBPACK_IMPORTED_MODULE_0__.default
});

/***/ }),

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/cards/Default.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/cards/Default.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/ui/LoadMore.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/ui/LoadMore.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _dc_post_grid_layout_ui_LoadMore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dc-post-grid/layout/ui/LoadMore */ "../../plugins/dc-post-grid/src/layout/ui/LoadMore.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  "extends": _dc_post_grid_layout_ui_LoadMore__WEBPACK_IMPORTED_MODULE_0__.default
});
...
/***/ "./src/blocks/dc-post-grid/layout/DcPostGrid.vue":
/*!*******************************************************!*\
  !*** ./src/blocks/dc-post-grid/layout/DcPostGrid.vue ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _DcPostGrid_vue_vue_type_template_id_9212f040___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./
*/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/ui/LoadMore.vue?vue&type=template&id=f584e6ea&");
                  ...
                  _vm.currentPaged !== null
                    ? _c("Filters", {
                        ...
                        on: {
                          ...
                          "update-total-posts": _vm.updateTotalPosts,
...
var render = function() {
  ...
  return _c(
    ...
    {
      ref: "searchWrapper",
      class: ["dc-post-grid-input-wrapper", { focused: _vm.focused }],
      on: {
        click: function($event) {
      ...
      _c("fieldset", { ref: "dropdownWrapper" }, [
        ...
        _c(
          ...
          [
            _c("div", [
              _c("input", {
                attrs: { id: _vm.name + "-option-all", type: "checkbox" },
                domProps: { value: null },
                on: {
                  click: function($event) {
                    return _vm.reset()
              ...
              _c(
                "label",
                {
                  class: [
                    {
                      selected: !_vm.checkedValues.length
                    }
                  ],
                  attrs: { for: _vm.name + "-option-all" }
                },
                [_vm._v("All")]
              )
            ]),
    ...
    "button",
    {
      ...
      on: {
        click: function($event) {
          $event.stopPropagation()
          $event.preventDefault()
          return _vm.loadMore(_vm.currentPaged)
        }
      }
    },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGrid.vue?vue&type=template&id=9212f040&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGrid.vue?vue&type=template&id=9212f040& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGridResults.vue?vue&type=template&id=764bd526&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/DcPostGridResults.vue?vue&type=template&id=764bd526& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/Filters.vue?vue&type=template&id=07f9e5d0&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/Filters.vue?vue&type=template&id=07f9e5d0& ***!
  \**************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    ...
    { ref: "filtersWrapper", staticClass: "dc-post-grid-filters-wrapper" },
    [
      _vm.filterLabel ? _c("h3", [_vm._v(_vm._s(_vm.filterLabel))]) : _vm._e(),
      _vm._v(" "),
      _vm.searchFormPlaceholder
        ? _c(
            "div",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/cards/Default.vue?vue&type=template&id=4401f2aa&":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/cards/Default.vue?vue&type=template&id=4401f2aa& ***!
  \********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { ref: "cardContentWrapper", staticClass: "default-card__content" },
        [
          _c("div", { staticClass: "default-card__content__inner" }, [
            _vm.date
              ? _c("span", { staticClass: "post-date" }, [
                  _vm._v(_vm._s(_vm.date))
                ])
          ...
          _vm.url
            ? _c(
                "a",
                {
                  ref: "postLink",
                  staticClass:
                    "dc-button dc-button--has-icon dc-button--color-orange",
                  attrs: {
                    href: _vm.url,
                    "aria-label": "Read article: " + _vm.title
                  }
                },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/ui/LoadMore.vue?vue&type=template&id=f584e6ea&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/blocks/dc-post-grid/layout/ui/LoadMore.vue?vue&type=template&id=f584e6ea& ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "dc-post-grid-pagination-wrapper" }, [
    _c("p", [
      _vm._v(
        "showing " +
          _vm._s(_vm.totalVisiblePosts) +
          " of " +
    ...
    _c(
      "button",
      {
        class: [
          ...
          "dc-button--has-title",
          "dc-button--has-icon",
          "dc-button--color-grey",
          { "dc-button--is-loading": _vm.loading }
        ],
        on: {
          click: function($event) {
            $event.stopPropagation()
      ...
      [_vm._v(_vm._s(_vm.label)), _c("span", { staticClass: "icon icon-plus" })]
    )
  ])
}
var staticRenderFns = []
...
/*!********************************************************!*\
  ...
  \********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _layout_DcPostGrid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../layout/DcPostGrid */ "./src/blocks/dc-post-grid/layout/DcPostGrid.vue");
...
if (dcPostGrids.length) {
  var _loop = function _loop(i) {
    ...
    console.log(dcPostGridData);
    new Vue({
      render: function render(h) {
        return h(_layout_DcPostGrid__WEBPACK_IMPORTED_MODULE_0__.default, {
